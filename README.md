...
|--------|-------------|---------|
| Chemin de conscience | Ceci est un jeu Puissance 4 développé en utilisant Vite, TypeScript, et déployé sur GitHub Pages. Le jeu permet à deux joueurs de choisir la couleur de leurs pièces et de jouer une partie traditionnelle de Connect 4 dans le navigateur. [App Link](https://chemins-de-conscience.vercel.app/) | ![preview chemin_de_conscience](conscience.png) |
