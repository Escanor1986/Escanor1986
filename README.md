...
| [Game On - Landing Page](https://github.com/Escanor1986/GameOn-website-FR) | Landing Page (JavaScript (front) - nodeJS/ExpressJS (back)) permettant l'ouverture d'une modal pour la complétion d'un formulaire d'inscription à un tournoi de jeu vidéo avec confirmation par email de votre inscription. [App Link](https://escanor1986.github.io/GameOn-website-FR/) | ![preview Game On](gameon.png) |
