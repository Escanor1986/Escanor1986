...
| [Kanap - site vente de canapé](https://github.com/Escanor1986/Kanap_Site_ECommerce) | Kanap est une plateforme e-commerce fullstack pour la vente de canapés, utilisant HTML5, CSS3, et JavaScript pour le frontend, et Node.js, Express, et MongoDB pour le backend. L'application offre une API REST sécurisée avec JWT pour l'authentification, déployée sur Heroku avec une interface utilisateur déployée sur GitHub Pages. [App Link](https://escanor1986.github.io/Kanap_Site_ECommerce/) | ![preview kanap](kanap.png) |
