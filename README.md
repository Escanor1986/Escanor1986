...
- **Développement de jeux et animations interactives** avec **PixiJS**.  
- **Intégration avec React via PixiReact** pour un **rendu fluide et performant**.  
- **Visualisation de données avancée** avec **Chart.js et ng2-charts**, intégrés à **React et Angular** pour des dashboards et graphiques interactifs.  
...
| [Kanap - site vente de canapé](https://github.com/Escanor1986/Kanap_Site_ECommerce) | Kanap est une plateforme e-commerce fullstack pour la vente de canapés, utilisant HTML5, CSS3, et JavaScript pour le frontend, et Node.js, Express, et MongoDB pour le backend. L'application offre une API REST déployée sur Heroku avec une interface utilisateur déployée sur GitHub Pages. [App Link](https://escanor1986.github.io/Kanap_Site_ECommerce/) | ![preview kanap](kanap.png) |
