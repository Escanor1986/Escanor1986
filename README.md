...
|--------|-------------|---------|
| [Page produit site e-commerce](https://github.com/Escanor1986/Page_produit_site_e_commerce) | 
  - Page produit d'un site de e-commerce en React avec TypeScript via Vite avec Tailwind et Storybook. 
  - Maquette depuis Figma. 
  - [App Link](https://escanor1986.github.io/Page_produit_site_e_commerce/) 
  - Technologies utilisées : React, TypeScript, Vite, Tailwind, Storybook, vitest, GitHub Actions | ![preview e-commerce](ecommerce.png) |
